  ...
  return <header className='header' ref={headerRef}>
    <Container>
        ...
        <div className='head d-flex align-items-center justify-content-between gap-4'>
            ...
            <div className='logo'>
                <img id="logo" src={logo} alt=''/><span>W</span>andarous
        ...
        <div className="nav_right d-flex align-items-center gap-4">
...

            {
                ...
                <>
                    ...
                    <>
                        <Button className='loginform'><Link className='Login' to='/login'>Login</Link></Button>
                        <Button className='Registerform'><Link className='Register' to='/register'>Register</Link></Button>
                    </>
                )
            }
